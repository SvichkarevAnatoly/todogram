...
public class BotControllerImpl implements BotController {
    ...
    @Autowired
    public void setStateMachineService(StateMachineService<States, Events> stateMachineService) {
    ...
    public void action() {
        ...
        final StateMachine<States, Events> stateMachine = stateMachineService.acquireStateMachine(userName);
